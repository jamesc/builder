...
CREATE TABLE origins (
    ...
    name text UNIQUE,
    owner_id bigint,
    session_sync boolean DEFAULT false,
...
CREATE TABLE origin_invitations (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    account_sync boolean DEFAULT false,
...
CREATE FUNCTION accept_origin_invitation_v1(oi_invite_id bigint, oi_ignore boolean) RETURNS void
    LANGUAGE plpgsql
    AS $$
  DECLARE
    oi_origin_id bigint;
...
CREATE FUNCTION add_audit_entry_v1(p_origin_id bigint, p_package_id bigint, p_channel_id bigint, p_operation smallint, p_trigger smallint, p_requester_id bigint, p_requester_name text) RETURNS SETOF audit
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION add_audit_package_entry_v1(p_origin_id bigint, p_package_id bigint, p_channel_id bigint, p_operation smallint, p_trigger smallint, p_requester_id bigint, p_requester_name text) RETURNS SETOF audit_package
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION add_audit_package_group_entry_v1(p_origin_id bigint, p_channel_id bigint, p_package_ids bigint[], p_operation smallint, p_trigger smallint, p_requester_id bigint, p_requester_name text, p_group_id bigint) RETURNS SETOF audit_package_group
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION check_account_in_origin_members_v1(om_origin_name text, om_account_id bigint) RETURNS TABLE(is_member boolean)
...
CREATE FUNCTION delete_origin_channel_v1(channel_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION delete_origin_integration_v1(in_origin text, in_integration text, in_name text) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION delete_origin_member_v1(om_origin_id bigint, om_account_name text) RETURNS void
    LANGUAGE sql
    AS $$
      DELETE FROM origin_members WHERE origin_id=om_origin_id AND account_name=om_account_name;
$$;

CREATE FUNCTION delete_origin_project_integration_v1(p_origin text, p_package text, p_integration text) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
CREATE FUNCTION delete_origin_project_v1(project_name text) RETURNS void
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION delete_origin_secret_v1(os_origin_id bigint, os_name text) RETURNS SETOF origin_secrets
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION demote_origin_package_group_v1(opp_channel_id bigint, opp_package_ids bigint[]) RETURNS void
    LANGUAGE sql
    AS $$
    DELETE FROM origin_channel_packages WHERE channel_id=opp_channel_id AND package_id = ANY(opp_package_ids);
$$;

CREATE FUNCTION demote_origin_package_v1(opp_channel_id bigint, opp_package_id bigint) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION get_all_origin_packages_for_origin_v1(op_id bigint) RETURNS SETOF origin_packages
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_channel_package_latest_v5(op_origin text, op_channel text, op_ident text, op_target text, op_visibilities text) RETURNS SETOF origin_packages
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_channel_package_v4(op_origin text, op_channel text, op_ident text, op_visibilities text) RETURNS SETOF origin_packages
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
    RETURN QUERY SELECT op.*
...
CREATE FUNCTION get_origin_channel_packages_for_channel_v3(op_origin text, op_channel text, op_ident text, op_visibilities text, op_limit bigint, op_offset bigint) RETURNS TABLE(total_count bigint, ident text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_channel_v1(ocg_origin text, ocg_name text) RETURNS SETOF origin_channels
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_channels_for_origin_v2(occ_origin_id bigint, occ_include_sandbox_channels boolean) RETURNS SETOF origin_channels
    LANGUAGE sql STABLE
    AS $$
    SELECT *
...
CREATE FUNCTION get_origin_integration_v1(in_origin text, in_integration text, in_name text) RETURNS SETOF origin_integrations
    LANGUAGE sql STABLE
    AS $$
  SELECT *
...
CREATE FUNCTION get_origin_integrations_for_origin_v1(in_origin text) RETURNS SETOF origin_integrations
    LANGUAGE sql STABLE
    AS $$
...
CREATE FUNCTION get_origin_integrations_v1(in_origin text, in_integration text) RETURNS SETOF origin_integrations
    LANGUAGE sql STABLE
    AS $$
  SELECT * FROM origin_integrations
...
CREATE FUNCTION get_origin_invitation_v1(oi_invitation_id bigint) RETURNS SETOF origin_invitations
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION get_origin_invitations_for_account_v1(oi_account_id bigint) RETURNS SETOF origin_invitations
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_invitations_for_origin_v1(oi_origin_id bigint) RETURNS SETOF origin_invitations
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_invitations_not_synced_with_account_v1() RETURNS SETOF origin_invitations
    LANGUAGE plpgsql STABLE
    AS $$
BEGIN
...
CREATE FUNCTION get_origin_package_channels_for_package_v4(op_ident text, op_visibilities text) RETURNS SETOF origin_channels
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_package_latest_v5(op_ident text, op_target text, op_visibilities text) RETURNS SETOF origin_packages
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
      RETURN QUERY SELECT *
...
CREATE FUNCTION get_origin_package_platforms_for_package_v4(op_ident text, op_visibilities text) RETURNS TABLE(target text)
    LANGUAGE sql STABLE
    AS $$
...
CREATE FUNCTION get_origin_package_v4(op_ident text, op_visibilities text) RETURNS SETOF origin_packages
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
    RETURN QUERY SELECT *
...
CREATE FUNCTION get_origin_package_versions_for_origin_v7(op_origin text, op_pkg text, op_visibilities text) RETURNS TABLE(version text, release_count bigint, latest text, platforms text)
    LANGUAGE sql STABLE
    AS $$
  WITH packages AS (
    SELECT *
...
CREATE FUNCTION get_origin_packages_for_origin_distinct_v4(op_ident text, op_limit bigint, op_offset bigint, op_visibilities text) RETURNS TABLE(total_count bigint, ident text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_packages_for_origin_v5(op_ident text, op_limit bigint, op_offset bigint, op_visibilities text) RETURNS TABLE(total_count bigint, ident text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
      RETURN QUERY SELECT COUNT(*) OVER () AS total_count, op.ident
...
CREATE FUNCTION get_origin_packages_unique_for_origin_v4(op_origin text, op_limit bigint, op_offset bigint, op_visibilities text) RETURNS TABLE(total_count bigint, name text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_private_encryption_key_v1(opek_name text) RETURNS SETOF origin_private_encryption_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_project_integrations_for_project_v2(in_origin text, in_name text) RETURNS SETOF origin_project_integrations
    LANGUAGE sql STABLE
    AS $$
...
CREATE FUNCTION get_origin_project_integrations_v2(in_origin text, in_name text, in_integration text) RETURNS SETOF origin_project_integrations
    LANGUAGE sql STABLE
    AS $$
  SELECT opi.* FROM origin_project_integrations opi
...
CREATE FUNCTION get_origin_project_list_v2(in_origin text) RETURNS SETOF origin_projects
    LANGUAGE sql STABLE
    AS $$
...
CREATE FUNCTION get_origin_project_v1(project_name text) RETURNS SETOF origin_projects
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_public_encryption_key_latest_v1(opek_name text) RETURNS SETOF origin_public_encryption_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_public_encryption_key_v1(opek_name text, opek_revision text) RETURNS SETOF origin_public_encryption_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_public_encryption_keys_for_origin_v1(opek_origin_id bigint) RETURNS SETOF origin_public_encryption_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_public_key_latest_v1(opk_name text) RETURNS SETOF origin_public_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_public_key_v1(opk_name text, opk_revision text) RETURNS SETOF origin_public_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_public_keys_for_origin_v1(opk_origin_id bigint) RETURNS SETOF origin_public_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_secret_key_v1(osk_name text) RETURNS SETOF origin_secret_keys
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION get_origin_secret_v1(os_origin_id bigint, os_name text) RETURNS SETOF origin_secrets
    LANGUAGE sql STABLE
    AS $$
  SELECT *
  FROM origin_secrets
...
CREATE FUNCTION get_origin_secrets_for_origin_v1(os_origin_id bigint) RETURNS SETOF origin_secrets
    LANGUAGE sql STABLE
    AS $$
  SELECT *
  FROM origin_secrets
...
CREATE FUNCTION ignore_origin_invitation_v1(oi_invitation_id bigint, oi_account_id bigint) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION insert_origin_channel_v1(occ_origin_id bigint, occ_owner_id bigint, occ_name text) RETURNS SETOF origin_channels
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
CREATE FUNCTION insert_origin_integration_v1(in_origin text, in_integration text, in_name text, in_body text) RETURNS SETOF origin_integrations
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION insert_origin_invitation_v1(oi_origin_id bigint, oi_origin_name text, oi_account_id bigint, oi_account_name text, oi_owner_id bigint) RETURNS SETOF origin_invitations
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
CREATE FUNCTION insert_origin_member_v1(om_origin_id bigint, om_origin_name text, om_account_id bigint, om_account_name text) RETURNS void
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION insert_origin_package_v3(op_origin_id bigint, op_owner_id bigint, op_name text, op_ident text, op_checksum text, op_manifest text, op_config text, op_target text, op_deps text, op_tdeps text, op_exposes text, op_visibility text) RETURNS SETOF origin_packages
    LANGUAGE plpgsql
    AS $$
    DECLARE
...
CREATE FUNCTION insert_origin_private_encryption_key_v1(opek_origin_id bigint, opek_owner_id bigint, opek_name text, opek_revision text, opek_full_name text, opek_body bytea) RETURNS SETOF origin_private_encryption_keys
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION insert_origin_project_v5(project_origin_name text, project_package_name text, project_plan_path text, project_vcs_type text, project_vcs_data text, project_owner_id bigint, project_vcs_installation_id bigint, project_visibility text, project_auto_build boolean) RETURNS SETOF origin_projects
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
CREATE FUNCTION insert_origin_public_encryption_key_v1(opek_origin_id bigint, opek_owner_id bigint, opek_name text, opek_revision text, opek_full_name text, opek_body bytea) RETURNS SETOF origin_public_encryption_keys
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
CREATE FUNCTION insert_origin_public_key_v1(opk_origin_id bigint, opk_owner_id bigint, opk_name text, opk_revision text, opk_full_name text, opk_body bytea) RETURNS SETOF origin_public_keys
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
CREATE FUNCTION insert_origin_secret_key_v1(osk_origin_id bigint, osk_owner_id bigint, osk_name text, osk_revision text, osk_full_name text, osk_body bytea) RETURNS SETOF origin_secret_keys
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION insert_origin_secret_v1(os_origin_id bigint, os_name text, os_value text) RETURNS SETOF origin_secrets
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION insert_origin_v2(origin_name text, origin_owner_id bigint, origin_owner_name text, origin_default_package_visibility text) RETURNS SETOF origins
    LANGUAGE plpgsql
    AS $$
  DECLARE
...
CREATE FUNCTION list_origin_by_account_id_v1(o_account_id bigint) RETURNS TABLE(origin_name text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION list_origin_members_v1(om_origin_id bigint) RETURNS TABLE(account_name text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION my_origins_v2(om_account_id bigint) RETURNS SETOF origins
    LANGUAGE sql STABLE
    AS $$
  SELECT o.*
  FROM origins o
...
CREATE FUNCTION promote_origin_package_group_v1(opp_channel_id bigint, opp_package_ids bigint[]) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION promote_origin_package_v1(opp_channel_id bigint, opp_package_id bigint) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION rescind_origin_invitation_v1(oi_invitation_id bigint, oi_owner_id bigint) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION search_all_origin_packages_dynamic_v7(op_query text, op_my_origins text) RETURNS TABLE(ident text)
    LANGUAGE sql STABLE
    AS $$
...
CREATE FUNCTION search_all_origin_packages_v6(op_query text, op_my_origins text) RETURNS TABLE(ident text)
    LANGUAGE sql STABLE
    AS $$
  SELECT op.ident
  FROM origin_packages op
...
CREATE FUNCTION search_origin_packages_for_origin_distinct_v1(op_origin text, op_query text, op_limit bigint, op_offset bigint) RETURNS TABLE(total_count bigint, ident text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
      RETURN QUERY SELECT COUNT(p.partial_ident[1] || '/' || p.partial_ident[2]) OVER () AS total_count, p.partial_ident[1] || '/' || p.partial_ident[2] AS ident
...
CREATE FUNCTION search_origin_packages_for_origin_v4(op_origin text, op_query text, op_limit bigint, op_offset bigint, op_my_origins text) RETURNS TABLE(total_count bigint, ident text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
      RETURN QUERY SELECT COUNT(*) OVER () AS total_count, op.ident
...
CREATE FUNCTION set_account_sync_v1(oi_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION set_packages_sync_v1(in_package_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION set_session_sync_v1(in_origin_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION sync_origins_v1() RETURNS TABLE(account_id bigint, account_name text, origin_id bigint, origin_name text)
    LANGUAGE plpgsql STABLE
    AS $$
  BEGIN
...
CREATE FUNCTION sync_packages_v2() RETURNS TABLE(account_id bigint, package_id bigint, package_ident text, package_deps text, package_target text)
    LANGUAGE sql STABLE
    AS $$
  SELECT owner_id, id, ident, deps, target FROM origin_packages WHERE scheduler_sync = false;
$$;

CREATE FUNCTION update_origin_package_v1(op_id bigint, op_owner_id bigint, op_name text, op_ident text, op_checksum text, op_manifest text, op_config text, op_target text, op_deps text, op_tdeps text, op_exposes text, op_visibility text) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION update_origin_project_v4(project_id bigint, project_origin_id bigint, project_package_name text, project_plan_path text, project_vcs_type text, project_vcs_data text, project_owner_id bigint, project_vcs_installation_id bigint, project_visibility text, project_auto_build boolean) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
CREATE FUNCTION update_origin_v1(origin_id bigint, op_default_package_visibility text) RETURNS void
    LANGUAGE sql
    AS $$
  UPDATE origins SET
...
CREATE FUNCTION update_package_visibility_in_bulk_v1(op_visibility text, op_ids bigint[]) RETURNS void
    LANGUAGE sql
    AS $$
...
CREATE FUNCTION upsert_origin_integration_v1(in_origin text, in_integration text, in_name text, in_body text) RETURNS SETOF origin_integrations
    LANGUAGE plpgsql
    AS $$
  BEGIN
    RETURN QUERY
...
CREATE FUNCTION upsert_origin_project_integration_v3(in_origin text, in_name text, in_integration text, in_body text) RETURNS SETOF origin_project_integrations
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE FUNCTION validate_origin_invitation_v1(oi_invite_id bigint, oi_account_id bigint) RETURNS TABLE(is_valid boolean)
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
CREATE VIEW origins_with_private_encryption_key_full_name_v1 AS
 SELECT origins.id,
    origins.name,
    origins.owner_id,
...
CREATE VIEW origins_with_secret_key_full_name_v2 AS
 SELECT origins.id,
    origins.name,
    origins.owner_id,
